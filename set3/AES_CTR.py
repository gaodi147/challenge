...
def crypt(c,key,nonce):
    ...
    for i in xrange(0,len(c)/32+1):
        aesxor=set1.AES_ECB.encrypt(nonce.decode('hex'),key).encode('hex')
        m += set1.hex_xor.hex_xor(c[32*i:32*(i+1)],aesxor)
...
if __name__ == '__main__':
    c=set1.HexBase64.base642hex('L77na/nrFsKvynd6HzOoG7GHTLXsTVu9qvY/2syLXzhPweyyMTJULu/6/kXX0KSvoOLSFQ==')
